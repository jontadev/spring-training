...
create table usuario (id bigint not null auto_increment, data_cadastro datetime(6) not null, nome varchar(255), senha varchar(255), primary key (id)) engine=InnoDB
